...
void APlayerCharacter::RestoreToFullHealth()
{
...
float APlayerCharacter::GetStaminaRecuperationFactor()
{
	return StaminaRecuperationFactor;
}

void APlayerCharacter::SetStaminaRecuperationFactor(float NewStaminaRecuperationFactor)
{
...
float APlayerCharacter::GetPsiPower()
{
	return CurrentPsiPower;
}

void APlayerCharacter::PsiBlast()
{
